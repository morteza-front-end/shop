    ...
    <div class="container">
      <div class="header__top">
        <div class="header__top-content">
          <h1 class="header__top-h1">
            بیت بایت : آسان ترین و مطمئئن ترین راه خرید
          </h1>
          <p class="header__top-p">
            با کمترین هزینه حرفه ای ترین محصولات را تهیه کنید
          </p>
        </div>
      ...
      <SwiperSlider>
        ...
        <router-link :to="{name:'Product',params:{id:4}}"
          class="swiper-slide"
          v-for="item in 6"
          :key="item"
        >
      ...
      <SwiperSlider>
        <template v-slot:title> لب تاپ </template>
        <a
          href="product.html"
          class="swiper-slide"
          v-for="item in 4"
